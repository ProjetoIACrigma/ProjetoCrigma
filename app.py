...
df2 = pd.read_excel("C:\IA\Filmes.xlsx")
# BAIXAR O QUE TEM NO PICKLE
with open('C:\IA\data.pkl', 'rb') as f:#para quem não sabe o pickle é uma biblioteca que armazena em um unico arquivo variaveis do codigos antigos
    data = pickle.load(f)
